...
const carouselItems = [
  ...
  },
  {
    ...
    link: "/services-categories/Income%20Tax",
  },
  {
    image: Compliances,
    ...
    link: "/services-categories/Compliance",
  },
  {
    image: Gst,
    heading: "GST Advisory",
        ...
        >
          <div className="relative w-full max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-4 bg-blue-950">
              ...
              >
                <Link to={carouselItems[currentIndex].link}>Know More ➡</Link>
              </button>
            </div>
